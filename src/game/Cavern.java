 ...
 *
 * There is an entrance to the cavern and a target location
...
public class Cavern {
    ...
    private static class Point {
        ...
        /** Return tree iff ob is a Point and with same row and col of this one. */
    ...
    /** Constructor: a new cavern of size (rws, cls).
     * Randomness rand is used to determine which grid tiles are open.
    ...
    /** Constructor;  a graph constructed from givenGraph and tiles givenTiles, 
    ...
    /** Generate a new random graph that fits within the grid and
    ...
    /** Return a randomly chosen entrance to the cavern (the only non-wall tile
     * along an edge of the grid), using rand. */
    ...
    /** Convert nodeStrList, which was output by {@code serialize()}, back into a {@code Cavern}.
